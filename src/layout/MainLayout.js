...
import { HomeOutlined, QuestionCircleOutlined, ContactsOutlined, PlayCircleOutlined } from '@ant-design/icons';
    ...
    return (
      <Layout>
        <Sider collapsible collapsed={collapsed} onCollapse={this.onCollapse}>
          {collapsed ? <div className="logo">T</div> : <div className="logo">Tristan</div>}
          <Menu
            theme="dark"
            mode="inline"
            defaultSelectedKeys={[
          ...
          >
            ...
            <Menu.Item key="1">
              <Link to="/game">
                <PlayCircleOutlined />
                <span className="menu-item-link">Game</span>
              </Link>
            </Menu.Item>
            <Menu.Item key="2">
              <Link to="/about">
        ...
        <Layout>
          {children}
          <Footer>
            <span>react boilerplate template from: </span>
            <a
              target="_blank"
